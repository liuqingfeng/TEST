...
int dstlen;
JNIEXPORT jint Java_com_ilbctest_Audio_MyAudio_VoiceEncode(JNIEnv* env, jobject thiz, jbyteArray SpeechData, jbyteArray BitstreamData, jint srclen)
{
	jbyte * speech = (jbyte*)(*env)->GetByteArrayElements(env, SpeechData, 0);
	jbyte * bitstream= (jbyte*)(*env)->GetByteArrayElements(env, BitstreamData, 0);
...
jint Java_com_ilbctest_Audio_MyAudio_VoiceDecode(JNIEnv* env, jobject thiz, jbyteArray BitstreamData, jbyteArray SpeechData, jint srclen)
{
	jbyte * bitstream= (jbyte*)(*env)->GetByteArrayElements(env, BitstreamData, 0);
	jbyte * speech = (jbyte*)(*env)->GetByteArrayElements(env, SpeechData, 0);
